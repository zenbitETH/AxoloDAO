...
export const STRINGS: Record<Locale, Dict> = {
  es: {
    ...
    dashboardHeroTitle: 'Estado clínico de parámetros',
    estadoStable: 'Óptimo',
    estadoVigilance: 'Vigilancia',
    estadoCritical: 'Alarma clínica',
  ...
  en: {
    ...
    dashboardHeroTitle: 'Parameter clinical status',
    estadoStable: 'Stable',
    estadoVigilance: 'Watch',
    estadoCritical: 'Clinical alarm',
  ...
  pt: {
    ...
    dashboardHeroTitle: 'Estado clínico de parâmetros',
    estadoStable: 'Estável',
    estadoVigilance: 'Vigilância',
    estadoCritical: 'Alarme clínico',
    'param.temp': 'Temperatura',
    'param.nh3': 'Amônia (NH₃)',
    'param.no2': 'Nitritos (NO₂)',
    'param.no3': 'Nitratos (NO₃)',
